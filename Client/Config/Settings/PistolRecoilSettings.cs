...
namespace PeinRecoilRework.Config.Settings
{
    public class PistolRecoilSettings
    {
        ...
        public static void Bind(ConfigFile Config, int order, string category)
        {
            ...
            DynamicReturnMinMax = Config.Bind(formattedCategory, "Dynamic Return Speed Multiplier Range", new Vector2(1f, 0.6f), new ConfigDescription("Minimum and maximum modifier used for upwards recoil angle multiplier.", null, new ConfigurationManagerAttributes { Order = 860 }));
