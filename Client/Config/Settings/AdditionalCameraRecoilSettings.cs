...
namespace PeinRecoilRework.Config.Settings
{
    public class AdditionalCameraRecoilSettings
    {
        ...
        public static void Bind(ConfigFile Config, int order, string category)
        {
            ...
            EnableSlowSpring = Config.Bind(formattedCategory, "Enable Slow Spring", false, new ConfigDescription("Enables slow additional camera recoil.", null, new ConfigurationManagerAttributes { Order = 980 }));            SlowSpringSpeed = Config.Bind(formattedCategory, "Slow Spring Speed", 18f, new ConfigDescription("Speed of the slow spring", null, new ConfigurationManagerAttributes { Order = 970 }));
            ...
            SlowSpringUseRealRecoilDir = Config.Bind(formattedCategory, "Slow Spring Use Real Recoil", true, new ConfigDescription("Makes slow spring use real recoil direction for impulse direction.", null, new ConfigurationManagerAttributes { Order = 919 }));
            SlowSpringRealRecoilVerticalMinMax = Config.Bind(formattedCategory, "Slow Spring Real Recoil Vertical Min/Max", new Vector2(1f, 1f), new ConfigDescription("Multiplier range for vertical recoil. X = minimum, Y = maximum.", null, new ConfigurationManagerAttributes { Order = 917 }));
            SlowSpringRealRecoilHorizontalMinMax = Config.Bind(formattedCategory, "Slow Spring Real Recoil Horizontal Min/Max", new Vector2(1f, 1f), new ConfigDescription("Multiplier range for horizontal recoil. X = minimum, Y = maximum.", null, new ConfigurationManagerAttributes { Order = 916 }));
            ...
            FastSpringRealRecoilVerticalMinMax = Config.Bind(formattedCategory, "Fast Spring Real Recoil Vertical Min/Max", new Vector2(1f, 1f), new ConfigDescription("Multiplier range for vertical recoil. X = minimum, Y = maximum.", null, new ConfigurationManagerAttributes { Order = 847 }));
            FastSpringRealRecoilHorizontalMinMax = Config.Bind(formattedCategory, "Fast Spring Real Recoil Horizontal Min/Max", new Vector2(1f, 1f), new ConfigDescription("Multiplier range for horizontal recoil. X = minimum, Y = maximum.", null, new ConfigurationManagerAttributes { Order = 846 }));
