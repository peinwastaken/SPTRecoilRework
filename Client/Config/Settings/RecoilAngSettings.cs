...
namespace PeinRecoilRework.Config.Settings
{
    public class RecoilAngSettings
    {
        ...
        public static void Bind(ConfigFile Config, int order, string category)
        {
            ...
            RecoilAngUpMult = Config.Bind(formattedCategory, "Recoil Rotation Up Mult", 0.5f, new ConfigDescription("Multiplier for hand recoil angle up/down.", new AcceptableValueRange<float>(-5f, 5f), new ConfigurationManagerAttributes { Order = 970 }));
            RecoilAngSideMult = Config.Bind(formattedCategory, "Recoil Rotation Side Mult", 0.5f, new ConfigDescription("Multiplier for sideways hand recoil.", new AcceptableValueRange<float>(-5f, 5f), new ConfigurationManagerAttributes { Order = 960 }));
            ...
            RecoilAngDamping = Config.Bind(formattedCategory, "Recoil Rotation Damping", 0.6f, new ConfigDescription("Hand recoil damping.", new AcceptableValueRange<float>(-5f, 5f), new ConfigurationManagerAttributes { Order = 920 }));
        }
    }
}
