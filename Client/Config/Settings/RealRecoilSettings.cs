...
namespace PeinRecoilRework.Config.Settings
{
    public class RealRecoilSettings
    {
        ...
        public static void Bind(ConfigFile Config, int order, string category)
        {
            ...
            RifleRealRecoilMult = Config.Bind(formattedCategory, "Rifle Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for rifles.", null, new ConfigurationManagerAttributes { Order = 790 }));
            PistolRealRecoilMult = Config.Bind(formattedCategory, "Pistol Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for pistols.", null, new ConfigurationManagerAttributes { Order = 780 }));
            SmgRealRecoilMult = Config.Bind(formattedCategory, "SMG Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for SMGs.", null, new ConfigurationManagerAttributes { Order = 770 }));
            ShotgunRealRecoilMult = Config.Bind(formattedCategory, "Shotgun Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for shotguns.", null, new ConfigurationManagerAttributes { Order = 760 }));
            SniperRealRecoilMult = Config.Bind(formattedCategory, "Sniper Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for sniper rifles.", null, new ConfigurationManagerAttributes { Order = 750 }));
            MarksmanRealRecoilMult = Config.Bind(formattedCategory, "Marksman Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for marksman rifles.", null, new ConfigurationManagerAttributes { Order = 740 }));
            ...
            GrenadeLauncherRealRecoilMult = Config.Bind(formattedCategory, "Grenade Launcher Real Recoil Multiplier", new Vector2(1f, 1f), new ConfigDescription("Real recoil multiplier for grenade launchers.", null, new ConfigurationManagerAttributes { Order = 720 }));
        }
    }
}
